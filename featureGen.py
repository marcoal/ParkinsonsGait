...
class FeatureGen:
    ...
    def getSensorMeanFeatureNames(self):
    ...
    def getStrideFeatureNames(self):
    ...
    def getFeatureNames(self):
        return self.getStrideFeatureNames() + self.getSensorMeanFeatureNames() + self.getCopAggNames() + self.getHeelStrikeNames()
